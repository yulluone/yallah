  ...
  return (
    <aside
      className={classnames(
        "flex-col absolute z-30  top-0 left-0 justify-between overflow-y-auto bg-light-300 min-w-screen text-dark-900  dark:bg-dark-100 transition-transform	h-full lg:min-h-screen  lg:translate-x-0 min-w-[300px]",
